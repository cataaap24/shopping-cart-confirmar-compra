...
public class ShoppingCartApp {
    ...
    public ShoppingCartApp(ProductRepository productRepository,
                           ...
                           ConfirmarCompraUseCase confirmarCompraUseCase, EliminarProductoDelCarritoUseCase eliminarProductoDelCarritoUseCase) {
    ...
    public OperationResult removeProductFromCart(int productId) { return eliminarProductoDelCarritoUseCase.execute(productId); }
}
